...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      { /* Doodle decorations - scattered around (10) */}
      <div className="absolute top-8 left-4 sm:top-12 sm:left-8 md:top-20 md:left-16 z-0 opacity-60 pointer-events-none">
        <img src="/doodle-1.png" alt="" className="w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24" />
      </div>

      <div className="absolute top-12 right-6 sm:top-16 sm:right-12 md:top-24 md:right-20 z-0 opacity-60 pointer-events-none">
        <img src="/doodle-2.png" alt="" className="w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20" />
      </div>

      <div className="absolute top-1/3 left-3 sm:left-6 md:left-12 z-0 opacity-60 pointer-events-none hidden sm:block">
        <img src="/doodle-3.png" alt="" className="w-14 h-14 sm:w-18 sm:h-18 md:w-28 md:h-28" />
      </div>

      <div className="absolute top-2/3 right-4 sm:right-8 md:right-16 z-0 opacity-60 pointer-events-none">
        <img src="/doodle-4.png" alt="" className="w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24" />
      </div>

      <div className="absolute bottom-24 left-6 sm:left-12 md:left-20 z-0 opacity-60 pointer-events-none">
        <img src="/doodle-5.png" alt="" className="w-14 h-14 sm:w-20 sm:h-20 md:w-32 md:h-32" />
      </div>

      <div className="absolute bottom-10 right-8 sm:right-16 md:right-24 z-0 opacity-60 pointer-events-none">
        <img src="/doodle-6.png" alt="" className="w-12 h-12 sm:w-16 sm:h-16 md:w-24 md:h-24" />
      </div>

      <div className="absolute top-1/4 right-1/3 sm:right-1/4 z-0 opacity-50 pointer-events-none hidden sm:block">
        <img src="/doodle-7.png" alt="" className="w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20" />
      </div>

      <div className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 z-0 opacity-50 pointer-events-none hidden md:block">
        <img src="/doodle-8.png" alt="" className="w-12 h-12 md:w-18 md:h-18 lg:w-24 lg:h-24" />
      </div>

      <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-0 opacity-40 pointer-events-none hidden lg:block">
        <img src="/doodle-9.png" alt="" className="w-20 h-20 lg:w-28 lg:h-28" />
      </div>

      <div className="absolute bottom-6 right-1/3 transform translate-x-8 z-0 opacity-40 pointer-events-none hidden lg:block">
        <img src="/doodle-10.png" alt="" className="w-14 h-14 lg:w-20 lg:h-20" />
      </div>
      ...
      `
              ...
              {/* Content (responsive, vertically centered) */}
              <div className="relative z-10 text-center p-6 sm:p-10 w-full flex flex-col items-center justify-center h-full">
                <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 sm:mb-5"
                  style={{
                ...
                <p className="text-sm sm:text-base text-green-100 max-w-2xl mx-auto mb-6 sm:mb-10">
              ...
              {!isLoading && albums.length > 0 && (
                <div className="flex flex-wrap justify-center gap-4 sm:gap-5" role="list">
                  {albums.map((album, index) => (
                    <div
                      key={album.id}
                      className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-md overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105 group"
                      role="listitem"
                    >
                      <img
